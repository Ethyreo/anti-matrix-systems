...
const Navigation = () => {
  ...
  return (
    <nav
      className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 animate-fade-in bg-background/95 backdrop-blur-lg border-b border-border shadow-lg"
    >
      {/* Scroll Progress Bar */}
      <div 
