      ...
      <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="line-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="var(--data)" stopOpacity="0.6" />
            <stop offset="100%" stopColor="var(--data)" stopOpacity="0.1" />
          </linearGradient>
        ...
        <circle r="4" fill="var(--data)" filter="url(#glow)">
        ...
        <circle r="5" fill="var(--signal)" filter="url(#glow)">
        ...
        <circle r="4" fill="var(--signal)" filter="url(#glow)">
        ...
        <circle r="3" fill="var(--data)" filter="url(#glow)">
        ...
        <circle r="3" fill="var(--signal)" filter="url(#glow)">
